...
if __name__ == '__main__':
    ...
    with open( cfg.DATA_DIR + '/' + 'Test_Faster_RCNN_R-50-PFN_2x_HICO_DET.pkl', "rb" ) as tf_rcnn:
        u_tf_rcnn = pickle._Unpickler(tf_rcnn)
        u_tf_rcnn.encoding = 'latin1'
        Test_RCNN = u_tf_rcnn.load()
