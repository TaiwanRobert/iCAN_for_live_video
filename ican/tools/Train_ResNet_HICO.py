...
if __name__ == '__main__':
    ...
    with open( cfg.DATA_DIR + '/' + 'Trainval_GT_HICO.pkl', "rb" ) as gt:
        u_gt = pickle._Unpickler(gt)
        u_gt.encoding = 'latin1'
        Trainval_GT = u_gt.load()
        
    with open( cfg.DATA_DIR + '/' + 'Trainval_Neg_HICO.pkl', "rb" ) as neg:
        u_neg = pickle._Unpickler(neg)
        u_neg.encoding = 'latin1'
        Trainval_N = u_neg.load()
